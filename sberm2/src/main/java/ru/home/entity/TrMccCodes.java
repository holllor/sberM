...
@NamedQueries({
    @NamedQuery(name = "TrMccCodes.findAll", query = "SELECT t FROM TrMccCodes t")})
public class TrMccCodes implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TrMccCodes)) {
            return false;
        }
        TrMccCodes other = (TrMccCodes) object;
    ...
    public String toString() {
        return "ru.home.entity.TrMccCodes[ id=" + id + " ]";
    }
